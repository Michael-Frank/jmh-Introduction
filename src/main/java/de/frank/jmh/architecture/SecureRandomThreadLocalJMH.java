 ...
 *  a) cache SecureRandom instances, as initialization costs are high due to seeding with syscall's
 *  b) but... you have to cache them in a ThreadLocal due to lock contention in synchronized {@link java.security.SecureRandomSpi#engineNextBytes(byte[])}
 ...
 *     This especially helps a lot with code (libraries) using uncached "new SecureRandom()"
 *
 * 16 Threads @ JDK 1.8.0_212, OpenJDK 64-Bit Server VM, 25.212-b04
 *
 * Benchmark                    Mode  Cnt   Score                gc.alloc.rate.norm
 * threadLocal                 thrpt   30  2934500 ± 12980 ops/s    400 ±  0,0 B/op # winner - A Per-thread cached SecureRandom is 3-6x faster then sharing a single cached instance or creating new instances
 ...
 *   newSecureRandom_urandom   thrpt   30   966284 ± 11166 ops/s   1513 ± 57,0 B/op   # changing# the egd file helps a lot in this case (-Djava.security.egd=file:/dev/./urandom)
 *
 *
