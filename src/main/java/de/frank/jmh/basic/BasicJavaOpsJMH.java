...
public class BasicJavaOpsJMH {
	 ...
	 *   + operations perform very different when mixed and in sequence with other operations - like
	 *     they are ALLWAYS in real programs -> hint: cpu pipelining
	 *   + operations perform very different inside loops  (cpu pipelining and SIMD 
	 *     instructions
	 ...
	 *          200Million op/s
	 *   + Single Threaded benchmarking leaves room for a lot of other things to run 
	 *     fast in parallel like:
	 *     + Java c1 & c2 code compiler
	 *     + Multiple concurrent garbage collection threads
	 *     + thermal limit in your CPU
	 *     + Available cache in your cpu
